<template>
  <div>
    <h2 id="page-heading" data-cy="ProductCategoryHeading">
      <span v-text="$t('beautyApp.productCategory.home.title')" id="product-category-heading">Product Categories</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('beautyApp.productCategory.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'ProductCategoryCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('beautyApp.productCategory.home.createLabel')"> Create a new Product Category </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && productCategories && productCategories.length === 0">
      <span v-text="$t('beautyApp.productCategory.home.notFound')">No productCategories found</span>
    </div>
        ...
        <thead>
          <tr>
            ...
            <th scope="row" v-on:click="changeOrder('name')">
              <span v-text="$t('beautyApp.productCategory.name')">Name</span>
              <jhi-sort-indicator :current-order="propOrder" :reverse="reverse" :field-name="'name'"></jhi-sort-indicator>
            </th>
            <th scope="row" v-on:click="changeOrder('dsc')">
              <span v-text="$t('beautyApp.productCategory.dsc')">Dsc</span>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="beautyApp.productCategory.delete.question"
      ...
      <div class="modal-body">
        <p id="au-delete-productCategory-heading" v-text="$t('beautyApp.productCategory.delete.question', { id: removeId })">
