...
import CusAccountUpdateComponent from '@/entities/cus-account/cus-account-update.vue';
import CusAccountClass from '@/entities/cus-account/cus-account-update.component';
