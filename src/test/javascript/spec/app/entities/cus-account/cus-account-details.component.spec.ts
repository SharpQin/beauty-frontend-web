...
import CusAccountDetailComponent from '@/entities/cus-account/cus-account-details.vue';
import CusAccountClass from '@/entities/cus-account/cus-account-details.component';
