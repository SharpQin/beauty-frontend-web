...
import ProductItemUpdateComponent from '@/entities/product-item/product-item-update.vue';
import ProductItemClass from '@/entities/product-item/product-item-update.component';
