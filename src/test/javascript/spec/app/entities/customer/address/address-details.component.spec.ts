...
import AddressDetailComponent from '@/entities/customer/address/address-details.vue';
import AddressClass from '@/entities/customer/address/address-details.component';
