...
import AddressUpdateComponent from '@/entities/customer/address/address-update.vue';
import AddressClass from '@/entities/customer/address/address-update.component';
