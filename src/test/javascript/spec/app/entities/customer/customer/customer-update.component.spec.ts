...
import CustomerUpdateComponent from '@/entities/customer/customer/customer-update.vue';
import CustomerClass from '@/entities/customer/customer/customer-update.component';
