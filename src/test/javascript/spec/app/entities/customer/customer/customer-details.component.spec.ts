...
import CustomerDetailComponent from '@/entities/customer/customer/customer-details.vue';
import CustomerClass from '@/entities/customer/customer/customer-details.component';
