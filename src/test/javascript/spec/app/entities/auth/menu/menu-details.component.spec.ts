...
import MenuDetailComponent from '@/entities/auth/menu/menu-details.vue';
import MenuClass from '@/entities/auth/menu/menu-details.component';
import MenuService from '@/entities/auth/menu/menu.service';
